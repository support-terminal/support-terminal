package io.github.support.terminal.platform.app.domains.core.user.services;


import io.github.support.terminal.platform.app.domains.core.user.entities.CustomerUser;
import io.github.support.terminal.platform.app.domains.core.user.entities.Person;
import io.github.support.terminal.platform.app.domains.core.user.exceptions.UserNameAlreadyExistException;
import io.github.support.terminal.platform.app.domains.core.user.models.WebUserDTO;
import io.github.support.terminal.platform.app.domains.core.user.requests.WebUserRequest;
import io.github.support.terminal.platform.app.domains.core.user.values.UserStates;
import io.github.support.terminal.platform.app.domains.core.user.values.UsersGrantedAuthorities;
